        ...
        <main className="post-details-container">
            ...
            <article className="full-post">
                <header className="post-header">
                    ...
                    <div className="post-author-meta">
                        <div className="author-info">
                            ...
                            <div>
                                <span className="author-name">{showPostDetails.auther}</span>
                                <div className="post-date-row">
                                    <span>
                                        <FaCalendarAlt />{showPostDetails.createdAt}
                                    </span>
                ...
                <div className="post-body">
                    <p>{showPostDetails.description}
                    </p>
                    <p>
                        This layout structure remains exactly the same as your dynamic but now
                        it works as a pure static UI component.
                    </p>
                </div>
